...
이 프로젝트는 **League of Legends (LoL) 교내/커뮤니티 토너먼트**를 효율적으로 운영하고 관리하기 위해 개발된 웹 애플리케이션입니다.

참가자 등록부터 팀 구성, 대진표 생성, 승패 기록까지 대회의 전 과정을 관리자가 웹상에서 손쉽게 처리할 수 있습니다. 특히 Riot API를 연동하여 참가자의 실제 티어를 자동으로 검증하는 기능을 포함하고 있습니다.
